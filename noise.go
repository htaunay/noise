...
var hm = [...]uint8{
	...
	// duplicate hash_mask to avoid out of bound indexes
	151, 160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53, 194, 233, 7, 225,
	140, 36, 103, 30, 69, 142, 8, 99, 37, 240, 21, 10, 23, 190, 6, 148,
	247, 120, 234, 75, 0, 26, 197, 62, 94, 252, 219, 203, 117, 35, 11, 32,
	57, 177, 33, 88, 237, 149, 56, 87, 174, 20, 125, 136, 171, 168, 68, 175,
...
func noise(x, y, frequency float64) float64 {
	...
	h0 := int(hm[ix0])
	h1 := int(hm[ix1])
	g00 := grad[hm[h0+iy0]&grad_size]
	g10 := grad[hm[h1+iy0]&grad_size]
	g01 := grad[hm[h0+iy1]&grad_size]
	g11 := grad[hm[h1+iy1]&grad_size]
